-- =========================================
-- PHASE 1: MILKATPOST PLATFORM DATABASE MIGRATION
-- =========================================
...
('general', 'What is MilkatPost?', 'MilkatPost is a comprehensive real estate platform connecting buyers, sellers, brokers, and developers across multiple countries. We specialize in NRI property investments and provide end-to-end real estate solutions.', 1, ARRAY['platform', 'about']),
