-- Fix authentication flow - create user_roles entry for existing users
...
-- Create a trigger to automatically create user_roles entries when profiles are created/updated
