-- Make phone column nullable in user_roles table since not all users have phone numbers
ALTER TABLE user_roles ALTER COLUMN phone DROP NOT NULL;

-- Add the unique constraint to user_roles table  
