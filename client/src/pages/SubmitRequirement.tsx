...
const SubmitRequirement = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Attempting to insert requirement with data:', {
        user_id: user.id,
      ...
      if (error) {
        console.error('Supabase error during requirement insertion:', error);
        throw error;
      }
      ...
      const dashboardPath = profile ? getRoleBasedDashboardPath(profile.role) : '/';
