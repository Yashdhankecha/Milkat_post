          ...
          <div className="rounded-lg bg-gradient-primary text-white p-8 md:p-12 shadow-medium">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full md:w-auto">
                ...
                <a href="mailto:support@milkatpost.com" className="flex items-center justify-center gap-2 bg-white/10 text-white rounded-md h-12 px-6 font-medium hover:bg-white/15 transition-colors">
                  <Mail className="w-4 h-4" />
                  support@milkatpost.com
                </a>
              </div>
            </div>
          </div>
