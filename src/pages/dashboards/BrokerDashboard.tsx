...
const BrokerDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      if (brokerData) {
        // For now, using mock data since we need to implement the full broker system
        setStats({
          totalListings: 0,
          activeClients: 0,
          totalCommission: 0,
  ...
  const createBrokerProfile = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Broker profile created! Please complete your profile setup."
      })
    } catch (error) {
      toast({
        title: "Error",
        description: "Failed to create broker profile",
        variant: "destructive"
      })
    }
  }
          ...
          <Card className="text-center py-12">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-4 justify-center">
                <Button onClick={createBrokerProfile} size="lg">
                  <UserPlus className="w-5 h-5 mr-2" />
                  Set Up Broker Profile
                </Button>
                <Button asChild variant="outline" size="lg">
                  <Link to="/nri-broker-registration">
